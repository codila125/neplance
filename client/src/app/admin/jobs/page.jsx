    ...
    <main className="section" style={{ backgroundColor: "var(--color-bg-page)" }}>
      <div className="container">
        <div className="card" style={{ padding: "var(--space-8)" }}>
          ...
          <form method="get" style={{ display: "flex", gap: "var(--space-4)", marginBottom: "var(--space-4)" }}>
            <input name="search" aria-label="Search jobs" defaultValue={search} placeholder="Search by title or description" className="input" style={{ flex: 1 }} />
